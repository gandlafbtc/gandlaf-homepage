<footer class="footer p-10 bg-neutral text-neutral-content">
	<div>
		...
		<a class="link link-hover flex gap-2" href="https://github.com/gandlafbtc">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				viewBox="0 0 496 512"
				class="w-4 h-4 text-gray-100"
		...
		<a class="link link-hover  flex gap-2"
			><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-4 h-4 text-gray-100"
            stroke="currentColor"
            fill="currentColor"
				><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
            ...
            @gandlaf21</a
		>
		<a class="link link-hover" href="mailto:gandlaf@proton.me">PGP: 67D9 909E 481D 03F1</a>
	</div>
	<div>
